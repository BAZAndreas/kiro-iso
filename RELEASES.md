...
Each release entry answers the same three things: why it was worth a new ISO, what functionality it added, and the package moves behind it. Newest first. From **2026/07/01** Kiro switches to **one official ISO per month**; the v26.07.01 ISO was the first, and **v26.09.01** is the current release (there is no August build — July and August are the holiday period).

## v26.09.01 — September 1 (current)
